...
function Footer() {
    return (
        <footer className="w-full bg-black">
            <div className="flex justify-around items-center gap-[133px] p-[20px]">
                <div>
                    <h4 className="text-[18px] text-[rgba(255,255,255,0.8)] mb-[20px]">Company</h4>
                    <p className="text-[16px]  text-[rgba(255,255,255,0.5)]">About Us</p>
                    <p className="text-[16px]  text-[rgba(255,255,255,0.5)]">Careers</p>
                </div>
                <div>
                    <h4 className="text-[18px] text-[rgba(255,255,255,0.8)] mb-[20px]">Need Help</h4>
                    <p className="text-[16px]  text-[rgba(255,255,255,0.5)]">Visit Help Center?</p>
                    <p className="text-[16px]  text-[rgba(255,255,255,0.5)]">Share Feedback</p>
                </div>
                <div>
                    <h4 className="text-[18px] text-[rgba(255,255,255,0.8)] mb-[20px]">View Website in</h4>
                ...
                <div>
                    <h4 className="text-[18px] text-[rgba(255,255,255,0.8)] mb-[20px]">Social Media</h4>
                    <div className="icon">
                ...
                <div>
                    <h4 className="text-[18px] text-[rgba(255,255,255,0.8)] mb-[20px]">Download Our App</h4>
                    <div className="flex justify-center items-center text-[white] ionIcon bg-[black] rounded-2xl gap-[5px] mb-[17px] p-[5px]">
                        <ion-icon name="logo-apple"></ion-icon>
                        <div>
                            <p className="text-[12px] text-[rgba(255,255,255,0.9)]">Download on the</p>
                            <h5>App Store</h5>
                        </div>
                    </div>
                    <div className="flex justify-center items-center text-[white] ionIcon bg-[black] rounded-2xl gap-[5px] p-[5px]">
                        ...
                        <div>
                            <p className="text-[12px] text-[rgba(255,255,255,0.9)]">GET IT ON</p>
                            <h5>Google Play</h5>
                        </div>
                    </div>
                </div>
